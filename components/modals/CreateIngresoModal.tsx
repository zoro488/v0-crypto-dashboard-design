  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Se ha registrado el ingreso de $${ingreso.monto.toLocaleString()} correctamente.`,
      })
      ...
      toast({
        title: "Error",
        description: "Error al registrar el ingreso. Por favor intenta de nuevo.",
        variant: "destructive",
      })
    }
  }
