...
interface CreateIngresoModalSmartProps {
  isOpen: boolean
  onClose: () => void
  onSubmit?: (data: IngresoFormData) => void
}
...
export default function CreateIngresoModalSmart({ 
  ...
  const onFormSubmit = async (data: IngresoFormData) => {
  ...
  const canAdvanceStep2 = watchedConcepto && watchedConcepto.length >= 2 && watchedMonto > 0
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[85vh] overflow-y-auto bg-black/95 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-2xl shadow-emerald-500/10 z-50"
          >
            {/* Header con gradiente premium */}
            <div className="relative p-6 sm:p-8 border-b border-white/10 bg-gradient-to-r from-emerald-900/30 via-green-900/20 to-emerald-900/30">
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h2 className="text-2xl sm:text-3xl font-bold text-white">Registrar Ingreso</h2>
                    <p className="text-gray-400 text-sm">Registra un ingreso a un banco</p>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="flex justify-end pt-4">
                      <motion.button
                        ...
                        className="px-8 py-4 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-500 hover:to-green-500 text-white rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-emerald-500/25"
                      >
                        Continuar →
                      </motion.button>
                    </div>
                  ...
                  >
                    ...
                    {selectedBanco && (
                      <div className="p-3 rounded-xl bg-white/5 border border-white/10 flex items-center justify-between">
                        ...
                        <span className="text-gray-400">
                          Actual: ${(selectedBanco.saldo ?? 0).toLocaleString()}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="flex gap-4 pt-4">
                      ...
                      <motion.button
                        ...
                        className="flex-1 px-8 py-4 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-500 hover:to-green-500 text-white rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-emerald-500/25"
                      >
                        {isSubmitting ? (
