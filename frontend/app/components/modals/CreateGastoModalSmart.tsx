      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[85vh] overflow-y-auto bg-black/95 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-2xl shadow-red-500/10 z-50"
          >
