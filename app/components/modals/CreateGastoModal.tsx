...
export default function CreateGastoModal({ isOpen, onClose }: CreateGastoModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Crear gasto usando el servicio de Firestore
      ...
      logger.error("Error creating gasto", error, { context: "CreateGastoModal" })
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Error al registrar el gasto. Por favor intenta de nuevo.",
        variant: "destructive",
      })
    }
  }
