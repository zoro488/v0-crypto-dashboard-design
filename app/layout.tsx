...
// Usar fonts de sistema como fallback cuando Google Fonts no está disponible en el entorno de build
...
export default function RootLayout({
  ...
  return (
    <html lang="es" suppressHydrationWarning className="dark" style={{ backgroundColor: 'hsl(240 10% 3.9%)', colorScheme: 'dark' }}>
      <body className="font-sans antialiased bg-background text-foreground" suppressHydrationWarning style={{ backgroundColor: 'hsl(240 10% 3.9%)', color: 'hsl(0 0% 98%)', minHeight: '100vh', fontFamily: 'ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
        <Script
          id="disable-devtools"
